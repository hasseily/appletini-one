...
def static_checks() -> None:
    ...
    require("assign apple_res_pin = 1'bz;" in wrapper and
            "assign apple_reset_n_out = physical_bus_fault_isolate ? 1'b1 :" in top and
    ...
    require("LUT6 #(.INIT(64'hFFFF_FFFF_8088_8080)) apple_data_enable_lut" in wrapper and
            ".I0(physical_bus_emit_allowed)," in wrapper and
            ...
            ".I5(physical_data_override_allowed)," in wrapper and
            "physical_bus_emit_allowed = bus_emit_state && !physical_bus_isolate;" in wrapper and
            "physical_data_override_allowed = data_override_safe &&" in wrapper and
            ".O(apple_data_enable)" in wrapper and
            "physical_data_en_q    <= ab_write.wr_data_en;" in wrapper and
            "physical_data_q <= ab_write.wr_data;" in wrapper and
            "physical_ownership_dependent_q <= ab_write.assert_inh ||" in wrapper and
            "iiplus_read_inh_dependent_q <=" in wrapper and
            "physical_ownership_dependent_q;" in wrapper and
            "(!physical_ownership_dependent_q || inh_allowed)" in wrapper and
