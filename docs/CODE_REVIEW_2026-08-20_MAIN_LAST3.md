...
| 12 | **Rejected at the time.** Keeping Disk II selected while physical slot 6 was off was intentional for ONE//e. F1.0.3 supersedes that rule: Slot 6 OFF now selects SmartPort for all modes. | **Superseded by F1.0.3.** | The current config, service, and bus paths all treat Slot 6 OFF as authoritative. |
