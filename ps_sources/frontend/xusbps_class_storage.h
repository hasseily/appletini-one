...
typedef struct {
	u64 read_bytes;
	u64 write_requested_bytes;
	u64 write_received_bytes;
	u64 write_committed_bytes;
	u64 read_ticks;
	u64 write_rx_ticks;
	u64 write_total_ticks;
	u64 last_read_ticks;
	u64 last_write_rx_ticks;
	u64 last_write_total_ticks;
	u64 max_read_ticks;
	u64 max_write_rx_ticks;
	u64 max_write_total_ticks;
	u32 read_cmds;
	u32 write_cmds;
	u32 read_failures;
	u32 write_failures;
	u32 write_async_failures;
	u32 write_overflows;
	u32 write_pending_slots;
	u32 max_write_pending_slots;
	u32 write_pipe_depth;
	...
	u64 cbw_packets;
	u64 scsi_cmds;
	u64 cmd_test_unit_ready;
	u64 cmd_inquiry;
	u64 cmd_get_cap_list;
	u64 cmd_read_capacity;
	u64 cmd_mode_sense;
	u64 cmd_request_sense;
	u64 cmd_read10;
	u64 cmd_write10;
	u64 cmd_medium_removal;
	u64 cmd_verify;
	u64 cmd_sync_cache;
	u64 cmd_start_stop;
	u64 cmd_format;
	...
	u32 last_sense_key;
	u32 last_sense_asc;
	u32 ep1_idle_wait_timeouts;
	u32 prime_watchdog_recoveries;
	u32 ring_full_recoveries;
	u32 csw_send_failures;
	u32 csw_retries;
	u32 ep1_protocol_stalls;
} usb_storage_class_stats_t;
...
int XUsbPs_StorageTryFastRx(XUsbPs *InstancePtr, u8 *BufferPtr,
			    u32 BufferLen);
