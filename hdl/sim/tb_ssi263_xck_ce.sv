...
module tb_ssi263_xck_ce;
    ...
    initial begin
        ...
        // Vary phase and duty cycle.  Each level lasts at least three fabric
        // clocks, far longer than the real Q3 input requires at 133 MHz.
        #3;
        ...
        // A held-high Q3 level must produce one edge, not a free-running CE.
        q3_raw = 1'b1;
        #200ns;
        q3_raw = 1'b0;
        #80ns;
        ...
        // Reset clears all synchronized history and suppresses the enable.
        @(negedge clk);
        rstn = 1'b0;
        q3_raw = 1'b0;
